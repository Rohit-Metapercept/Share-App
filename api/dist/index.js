...
//From EP:1
_awsSdk2.default.config.update(_config.s3Config); //From EP:1
//From EP:1
...
var storageDir = _path2.default.join(__dirname, '..', 'storage'); //From EP:1


//const upload = multer({ storage: storageConfig }); // local upload.

var upload = (0, _multer2.default)({ //From EP:1
